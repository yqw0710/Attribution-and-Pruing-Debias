...
def main():
    ...
    parser.add_argument("--train_path", type=str, default="../data/moji/trainmoji.pkl")
    ...
    parser.add_argument("--output_dir", type=str,
                        default='../model_save/moji/bert/original',
    ...
    model = BertForSequenceClassification.from_pretrained(
        args.model_name_or_path, state_dict=torch.load(args.model_file), num_labels=2)
